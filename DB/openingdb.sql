...
INSERT INTO `Opening` (`id`, `name`, `piece_color`, `tutorial_link`, `type`, `image_url`, `common`) VALUES (3, 'Caro-Kann Defense', 'Black', 'https://www.youtube.com/watch?v=rmbU97iftC8&ab_channel=GothamChess', 'Semi-Open', 'https://i0.wp.com/chesspathways.com/wp-content/uploads/2019/08/2i-300x300.png?ssl=1', 1);
INSERT INTO `Opening` (`id`, `name`, `piece_color`, `tutorial_link`, `type`, `image_url`, `common`) VALUES (4, 'Queens Gambit', 'White', 'https://www.youtube.com/watch?v=kGBubryqi3s&ab_channel=AnnaCramling', 'Gambit', 'https://i2.wp.com/chesspathways.com/wp-content/uploads/2019/08/6a-300x300.png?ssl=1', 1);
...
INSERT INTO `Opening` (`id`, `name`, `piece_color`, `tutorial_link`, `type`, `image_url`, `common`) VALUES (8, 'Budapest Gambit', 'Black', 'https://www.youtube.com/watch?v=urITvqQleUE&ab_channel=thechesswebsite', 'Gambit', 'https://i2.wp.com/chesspathways.com/wp-content/uploads/2019/09/42a-300x300.png?ssl=1', 0);
INSERT INTO `Opening` (`id`, `name`, `piece_color`, `tutorial_link`, `type`, `image_url`, `common`) VALUES (9, 'Alekhine Defence', 'Black', NULL, 'Hyper modern', 'https://i1.wp.com/chesspathways.com/wp-content/uploads/2019/08/2k-300x300.png?ssl=1', 0);
